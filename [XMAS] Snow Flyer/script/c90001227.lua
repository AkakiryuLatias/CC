...
function c90001227.efilter(e,c)
	return c:IsSetCard(0xc9) or c:IsSetCard(0x4c9) or c:IsSetCard(0x5c9)
end

--don't even bother to Raigeki me
function c90001227.indtg(e,c)
	return c:IsFaceup() and (c:IsSetCard(0xc9) or c:IsSetCard(0x4c9) or c:IsSetCard(0x5c9)) and c:IsRace(RACE_BEAST)
end
...
function c90001227.adcon(e)
	...
	return (d:IsSetCard(0xc9) or d:IsSetCard(0x4c9) or d:IsSetCard(0x5c9))
end
