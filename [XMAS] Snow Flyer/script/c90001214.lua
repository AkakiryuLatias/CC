...
function c90001214.filter1(c)
	return c:IsSetCard(0x4c9) or c:IsSetCard(0x5c9) or c:IsSetCard(0xc9) and c:IsAbleToHand()
end
...
function c90001214.filter2(c)
	return c:IsSetCard(0x4c9) or c:IsSetCard(0x5c9) and c:IsType(TYPE_MONSTER)
end
