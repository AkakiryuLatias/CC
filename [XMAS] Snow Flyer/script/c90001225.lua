...
function c90001225.chainop(e,tp,eg,ep,ev,re,r,rp)
	...
	if re:IsHasType(EFFECT_TYPE_ACTIVATE) and (rc:IsSetCard(0xc9) or rc:IsSetCard(0x4c9) or rc:IsSetCard(0x5c9)) then
...
function c90001225.dmcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return rc:IsRelateToBattle() and (rc:IsSetCard(0xc9) or rc:IsSetCard(0x4c9) or rc:IsSetCard(0x5c9)) and rc:IsFaceup() and rc:IsControler(tp)
end
