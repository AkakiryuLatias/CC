...
function c90001219.initial_effect(c)
	...
	--indes (Flash Flyer)
	local e3=e1:Clone()
	e3:SetTarget(aux.TargetBoolFunction(Card.IsSetCard,0x5c9))
	c:RegisterEffect(e2)
	--atk/def down (field)
...
function c90001219.filter(c)
	return c:IsFaceup() and (c:IsSetCard(0xc9) or c:IsSetCard(0x4c9) or c:IsSetCard(0x5c9)) and c:IsType(TYPE_MONSTER)
end
